...
SelectedJetProducer = cms.EDProducer(
    ...
    jecFileAK8_2018 = cms.string("Autumn18_V19_MC_UncertaintySources_AK8PFchs.txt"),
    
    jecFileAK4_2016 = cms.string("Regrouped_Summer16_07Aug2017_V11_MC_UncertaintySources_AK4PFchs.txt"),
    jecFileAK4_2017 = cms.string("Regrouped_Fall17_17Nov2017_V32_MC_UncertaintySources_AK4PFchs.txt"),
    jecFileAK4_2018 = cms.string("Regrouped_Autumn18_V19_MC_UncertaintySources_AK4PFchs.txt"),

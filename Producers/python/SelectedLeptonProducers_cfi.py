...
SelectedElectronProducer2017 = cms.EDProducer(
    ...
    file_EleVetoIDSF=cms.string(
        "BoostedTTH/Producers/data/electronSFs/2017_ElectronWPVeto_Fall17V2.root"
    ),
...
SelectedElectronProducer2016 = SelectedElectronProducer2017.clone(
    era=cms.string("2016"),
    file_EleVetoIDSF=cms.string(
        "BoostedTTH/Producers/data/electronSFs/2016_ElectronWPVeto_Fall17V2.root"
    ),
    file_EleLooseIDSF=cms.string(
...
SelectedElectronProducer2018 = SelectedElectronProducer2017.clone(
    era=cms.string("2018"),
    file_EleVetoIDSF=cms.string(
        "BoostedTTH/Producers/data/electronSFs/2018_ElectronWPVeto_Fall17V2.root"
    ),
    file_EleLooseIDSF=cms.string(

...
public:
  ...
  double kSmear(double pt, double eta, TYPE type, double v, double u, int n)
    const;
...
public:
  ...
  double kGenSmear(double pt,
                   ...
                   double v,
                   double u,
                   RocRes::TYPE TT = RocRes::Data) const;
...
public:
  ...
  double getM(int T, int H, int F, int E = 0, int m = 0) const
  {
    return RC[E][m].getM(T, H, F);
  }
  double getA(int T, int H, int F, int E = 0, int m = 0) const
  {
    return RC[E][m].getA(T, H, F);
  }
  double getK(int T, int H, int E = 0, int m = 0) const
  {

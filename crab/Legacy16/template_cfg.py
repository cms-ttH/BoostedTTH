...
config.JobType.psetName = '/nfs/dust/cms/user/swieland/ttH/CMSSW_9_4_13/src/BoostedTTH/BoostedAnalyzer/test/skim.py'
...
config.Data.outputDatasetTag = 'KIT_tthbb_skims_MC_LEG_DATAERA'

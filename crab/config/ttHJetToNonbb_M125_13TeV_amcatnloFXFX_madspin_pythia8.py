...
config.General.requestName = 'ttHJetToNonbb_M125_13TeV_amcatnloFXFX_madspin_pythia8'
...
config.Data.publishDataName = 'Ana_ttHJetToNonbb_M125_13TeV_amcatnloFXFX_madspin_pythia8'

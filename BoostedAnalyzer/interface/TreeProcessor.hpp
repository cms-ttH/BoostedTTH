...
public:
  ...
  virtual void Init(const std::vector<InputCollections>& input,
                    VariableContainer& var);
  virtual void Process(const InputCollections& input,
                       VariableContainer& var) = 0;
  virtual void Process(const std::vector<InputCollections>& input,
                       VariableContainer& var);

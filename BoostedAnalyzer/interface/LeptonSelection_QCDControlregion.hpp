...
class LeptonSelection_QCDControlregion : public Selection {
 public:
  LeptonSelection_QCDControlregion(const edm::ParameterSet& iConfig,
                                   int step = -1);
  LeptonSelection_QCDControlregion(std::vector<std::string> electronTriggers,
                                   std::vector<std::string> muonTriggers,
                                   std::string channel = "both", int step = -1);
  LeptonSelection_QCDControlregion(std::string electronTrigger = "any",

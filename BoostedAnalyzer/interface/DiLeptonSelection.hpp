...
class DiLeptonSelection : public Selection {
 public:
  ...
  DiLeptonSelection(std::vector<std::string> elelTriggers,
                    ...
                    std::string channel = "all", int step = -1,
                    std::string dataset = "NA");
  DiLeptonSelection(std::string elelTrigger = "None",
                    std::string mumuTrigger = "None",
                    std::string elmuTrigger = "None",
                    std::string elTrigger = "None",
                    std::string muTrigger = "None", std::string channel = "all",
                    int step = -1, std::string dataset = "NA");
  ~DiLeptonSelection();

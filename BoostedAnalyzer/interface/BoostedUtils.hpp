...
class BoostedUtils{
  ...
  public:
    ...
    static float GetJetCSV(const pat::Jet& jet, const std::string& taggername = "pfCombinedInclusiveSecondaryVertexV2BJetTags"); 
    ...
    static float GetHiggsMass(const boosted::SubFilterJet& higgsJet, const int& nFilterJets = 2, const int& nBTags = 2, const float& csvWP = 0.89);

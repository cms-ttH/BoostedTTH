...
class PUWeights {
   public:
    ...
    void initNominalWeight(const std::string& fileNameMCNPU, const std::string& histNameMCNPU, const std::string& fileNameDataNPUEstimated,
                           const std::string& histNameDataNPUEstimated);

    void initAdditionalWeight(const std::string& name, const std::string& fileNameMCNPU, const std::string& histNameMCNPU,

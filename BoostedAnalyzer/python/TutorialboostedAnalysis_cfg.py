...
process.load("Configuration.StandardSequences.FrontierConditions_GlobalTag_condDBv2_cff")  # define database for globaltags
...
# the last time this was updated, the most recent JEC for data were not in the global database
if options.isData:
...
process.load("RecoEgamma.ElectronIdentification.ElectronMVAValueMapProducer_cfi") # load module that evaluates electron ID based on a MVA
process.load('Configuration.Geometry.GeometryRecoDB_cff') # load some other modules

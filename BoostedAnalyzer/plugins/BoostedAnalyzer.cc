...

{
    ...
    pointerToCommonBDT5Classifier.reset(new BDTClassifier(string(getenv("CMSSW_BASE"))+"/src/TTH/CommonClassifier/data/lj_BDT_DeepCSV_Summer18_v1/", CSVHelper::GetWP(era, CSVHelper::CSVwp::Medium, "DeepJet")));

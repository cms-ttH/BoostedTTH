...
if not options.inputFiles:
    if not options.isData:
        if "2016" in options.dataEra:
            ...
            options.inputFiles = [
                "file:///pnfs/desy.de/cms/tier2/store/user/mwassmer/TTToSemiLeptonic_TuneCP5_13TeV-powheg-pythia8/KIT_Monotop_skims_102X/190624_131536/0000/Skim_1.root"
            ]
    else:
        if "2016" in options.dataEra:  # CAREFUL: NO 2016 Data Skims ready yet
            ...
            options.inputFiles = [
                "file:///pnfs/desy.de/cms/tier2/store/user/mwassmer/MET/KIT_Monotop_skims_102X/190704_101037/0000/Skim_1.root"
            ]
...
process.BoostedAnalyzer.selectedJetsLoose = [
    cms.InputTag("SelectedJetProducerAK4" + s + ":selectedJetsLooseAK4" + s)
    for s in variations
]
...
if options.isData and options.useJson:
    ...
    if "2016" in options.dataEra:
        process.source.lumisToProcess = LumiList.LumiList(
            ...
            + "/src/BoostedTTH/BoostedAnalyzer/data/lumi_jsons/Cert_271036-284044_13TeV_23Sep2016ReReco_Collisions16_JSON.txt"
        ).getVLuminosityBlockRange()
    elif "2017" in options.dataEra:
        process.source.lumisToProcess = LumiList.LumiList(
            filename=os.getenv("CMSSW_BASE")
            + "/src/BoostedTTH/BoostedAnalyzer/data/lumi_jsons/Cert_294927-306462_13TeV_PromptReco_Collisions17_JSON.txt"
        ).getVLuminosityBlockRange()
    elif "2018" in options.dataEra:
        process.source.lumisToProcess = LumiList.LumiList(
            filename=os.getenv("CMSSW_BASE")
            + "/src/BoostedTTH/BoostedAnalyzer/data/lumi_jsons/Cert_314472-325175_13TeV_PromptReco_Collisions18_JSON.txt"
        ).getVLuminosityBlockRange()

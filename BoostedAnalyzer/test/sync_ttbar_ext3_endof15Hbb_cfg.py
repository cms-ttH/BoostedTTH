...
if not options.inputFiles:
    options.inputFiles=['file:/pnfs/desy.de/cms/tier2/store/user/shwillia/EndOf2015_HbbSync/ttbar_ext3_EndOf2015_HbbSync.root']
...
process.BoostedAnalyzer.outfileName = "sync_ttbar_ext3_endof15Hbb"

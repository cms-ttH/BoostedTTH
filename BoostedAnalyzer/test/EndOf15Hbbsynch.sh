...
cmsRun /nfs/dust/cms/user/shwillia/StartOf2016/CMSSW_7_4_15/src/BoostedTTH/BoostedAnalyzer/test/sync_tth_endof15Hbb_cfg.py

cmsRun /nfs/dust/cms/user/shwillia/StartOf2016/CMSSW_7_4_15/src/BoostedTTH/BoostedAnalyzer/test/sync_ttbar_endof15Hbb_cfg.py
...
for i in KIT_syncHBB/*.csv; do echo "$i"; python /nfs/dust/cms/user/shwillia/StartOf2016/CMSSW_7_4_15/src/BoostedTTH/BoostedAnalyzer/test/splitSLDL.py "$i"; done

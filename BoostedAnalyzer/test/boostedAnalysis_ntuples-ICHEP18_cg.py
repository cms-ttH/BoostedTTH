...
process.SelectedMuonProducer.ptMins=[15.]*3
...
process.SelectedMuonProducer.leptonIDs=["tightDL","tightDL","tightDL"]
process.SelectedMuonProducer.muonIsoConeSizes=["R04"]*3
process.SelectedMuonProducer.muonIsoCorrTypes=["deltaBeta"]*3
process.SelectedMuonProducer.muonIsoTypes = ["PFIsoLoose", "PFIsoLoose", "PFIsoLoose"]

...
if not options.inputFiles:
    if not options.isData:
        if "2016" in options.dataEra:
            options.inputFiles = [
                "file:///pnfs/desy.de/cms/tier2/store/user/mwassmer/TTToSemiLeptonic_TuneCP5_PSweights_13TeV-powheg-pythia8/KIT_Monotop_skims_2016_102X_v1/200104_171915/0000/Skim_9.root"
            ]
        elif "2017" in options.dataEra:
            options.inputFiles = [
                "file:///pnfs/desy.de/cms/tier2/store/user/kelmorab/TTToSemiLeptonic_TuneCP5_PSweights_13TeV-powheg-pythia8/KIT_Monotop_skims_2017_102X_v2/200710_140534/0000/Skim_9.root"
            ]
        elif "2018" in options.dataEra:
            options.inputFiles = [
        ...
        if "2016" in options.dataEra:  # CAREFUL: NO 2016 Data Skims ready yet
            ...
            options.inputFiles = [
                "file:///pnfs/desy.de/cms/tier2/store/user/mwassmer/MET/KIT_Monotop_skims_2016_102X_Run2016B_v1/200104_153651/0000/Skim_99.root"
            ]
        elif "2017" in options.dataEra:
            options.inputFiles = [
                "file:///pnfs/desy.de/cms/tier2/store/user/mwassmer/MET/KIT_Monotop_skims_2017_102X_Run2017F_v2/200710_140149/0000/Skim_99.root"
            ]
        elif "2018" in options.dataEra:
            options.inputFiles = [
...
process.GlobalTag.toGet = cms.VPSet(
    ...
    cms.PSet(record = cms.string("JetResolutionRcd"),
            ...
            connect = cms.string("sqlite_fip:BoostedTTH/BoostedAnalyzer/data/jerfiles/"+filename),
              label = cms.untracked.string("AK8PFPuppi_eta")
    ),
    cms.PSet(record = cms.string("JetResolutionRcd"),
    ...
    cms.PSet(record = cms.string("JetResolutionRcd"),
            ...
            connect = cms.string("sqlite_fip:BoostedTTH/BoostedAnalyzer/data/jerfiles/"+filename),
              label = cms.untracked.string("AK8PFchs_eta")
    ),
    cms.PSet(record = cms.string("JetResolutionRcd"),
    ...
    cms.PSet(record = cms.string("JetResolutionRcd"),
            ...
            connect = cms.string("sqlite_fip:BoostedTTH/BoostedAnalyzer/data/jerfiles/"+filename),
              label = cms.untracked.string("AK8PF_eta")
    ),
    cms.PSet(record = cms.string("JetResolutionRcd"),

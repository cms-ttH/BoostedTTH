...
options.register( "weight", 1.0, VarParsing.multiplicity.singleton, VarParsing.varType.float, "xs*lumi/(nPosEvents-nNegEvents)" )
...
options.register( "globalTag", "80X_dataRun2_2016SeptRepro_v7", VarParsing.multiplicity.singleton, VarParsing.varType.string, "global tag" )

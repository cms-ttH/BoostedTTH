...
jetToolbox( process, 'ak8', 'ak8JetSubs', 'out', runOnMC=runonMC, PUMethod='CHS', miniAOD=True,  addSoftDrop=True, addSoftDropSubjets=True, addNsub=True,  addNsubSubjets=True,  addCMSTopTagger=True, Cut='pt > 80', JETCorrPayload = 'AK8PFchs', subJETCorrPayload='AK4PFchs', JETCorrLevels = ['L1FastJet','L2Relative', 'L3Absolute'], subJETCorrLevels=['L1FastJet','L2Relative', 'L3Absolute']  )
...
process.SelectedJetProducerAK12=process.SelectedJetProducer.clone(jets='patSmearedJetsAK12',
                                                                applyCorrection=False,
                                                                ptMins=[80],
                                                                etaMaxs=[2.4],
                                                                collectionNames=["selectedJetsAK12"],
                                                                systematics=[""],
                                                                PUJetIDMins=["loose"],
                                                                JetID="none",
                                                                )

process.SelectedJetProducerAK15=process.SelectedJetProducer.clone(jets='patSmearedJetsAK15',
                                                                applyCorrection=False,
                                                                ptMins=[80],
                                                                etaMaxs=[2.4],
...
process.CorrectedJetProducerAK8=process.SelectedJetProducer.clone(jets=jetCollectionAK8, 
                                                               ptMins=[-1.],
                                                               etaMaxs=[999.],

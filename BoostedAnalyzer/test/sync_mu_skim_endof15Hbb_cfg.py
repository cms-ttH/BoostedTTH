...
if not options.inputFiles:
    options.inputFiles=['file:/pnfs/desy.de/cms/tier2/store/user/shwillia/EndOf2015_HbbSync/mu_skim_EndOf2015_HbbSync.root']
...
process.BoostedAnalyzer.outfileName = "sync_mu_skim_endof15Hbb"

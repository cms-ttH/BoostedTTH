...
if options.makeSystematicsTrees:
    ...
    process.BoostedAnalyzer.useregressedJets=True
    process.BoostedAnalyzer.regressedJets=[cms.InputTag("RegressedJetProducer:regressedJetsLoose")]
...
process.BoostedAnalyzer.minJets = [1]
process.BoostedAnalyzer.maxJets = [2]

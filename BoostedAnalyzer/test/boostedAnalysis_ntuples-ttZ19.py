...
if not options.inputFiles:
    if not options.isData:
        ...
        options.inputFiles=["file:///pnfs/desy.de/cms/tier2/store/user/mwassmer/ttHTobb_M125_TuneCP5_13TeV-powheg-pythia8/KIT_tthbb_sl_skims_MC_new_pmx_94X/181019_155115/0000/Skim_1.root"]
    else:

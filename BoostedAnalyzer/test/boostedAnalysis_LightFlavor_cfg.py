...
if options.isData:
	...
	process.load("BoostedTTH.BoostedAnalyzer.BoostedAnalyzer_dileptonNoTrigger_cfi")
...
process.BoostedAnalyzer.minJets = [2]
...
process.BoostedAnalyzer.selectionNames = cms.vstring("VertexSelection","DiLeptonSelection","MinDiLeptonMassSelection","JetTagSelection")
...
if options.isData:
  process.BoostedAnalyzer.processorNames=cms.vstring("WeightProcessor","MCMatchVarProcessor","BasicVarProcessor","DiLeptonVarProcessor","TriggerVarProcessor")
else:
  process.BoostedAnalyzer.processorNames=cms.vstring("WeightProcessor","MCMatchVarProcessor","BasicVarProcessor","DiLeptonVarProcessor","TriggerVarProcessor")

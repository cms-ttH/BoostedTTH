...
process.source = cms.Source(  "PoolSource",
                              fileNames = cms.untracked.vstring('file:/pnfs/desy.de/cms/tier2/store/user/shwillia/EndOf2015_HbbSync/muel_skim_EndOf2015_HbbSync.root'),
...
process.BoostedAnalyzer.outfileName = "sync_muel_skim_decSyncHbb"

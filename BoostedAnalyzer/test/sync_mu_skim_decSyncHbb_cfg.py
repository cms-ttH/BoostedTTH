...
process.source = cms.Source(  "PoolSource",
                              fileNames = cms.untracked.vstring('file:/pnfs/desy.de/cms/tier2/store/user/shwillia/EndOf2015_HbbSync/mu_skim_EndOf2015_HbbSync.root'),
...
process.BoostedAnalyzer.outfileName = "sync_mu_skim_decSyncHbb"

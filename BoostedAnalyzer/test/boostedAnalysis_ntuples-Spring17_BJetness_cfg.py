...
if options.calcBJetness:
    ...
    if options.isData:
        process.BJetness.is_data = cms.bool(True) #False or True depending on the format
    else:
    ...
    #The paths below have to be coherent with the place where you copied the JEC and JER directories as done in point 2.
    process.BJetness.jecPayloadNamesAK4PFchsMC1 = cms.FileInPath("MiniAOD/MiniAODHelper/data/jec/Summer16_23Sep2016V4_MC_L1FastJet_AK4PFchs.txt")
    process.BJetness.jecPayloadNamesAK4PFchsMC2 = cms.FileInPath("MiniAOD/MiniAODHelper/data/jec/Summer16_23Sep2016V4_MC_L2Relative_AK4PFchs.txt")
    process.BJetness.jecPayloadNamesAK4PFchsMC3 = cms.FileInPath("MiniAOD/MiniAODHelper/data/jec/Summer16_23Sep2016V4_MC_L3Absolute_AK4PFchs.txt")
    process.BJetness.jecPayloadNamesAK4PFchsMCUnc = cms.FileInPath("MiniAOD/MiniAODHelper/data/jec/Summer16_23Sep2016V4_MC_Uncertainty_AK4PFchs.txt")
    process.BJetness.jecPayloadNamesAK4PFchsDATA1 = cms.FileInPath("MiniAOD/MiniAODHelper/data/jec/Summer16_23Sep2016BCDV4_DATA_L1FastJet_AK4PFchs.txt")
    process.BJetness.jecPayloadNamesAK4PFchsDATA2 = cms.FileInPath("MiniAOD/MiniAODHelper/data/jec/Summer16_23Sep2016BCDV4_DATA_L2Relative_AK4PFchs.txt")
    process.BJetness.jecPayloadNamesAK4PFchsDATA3 = cms.FileInPath("MiniAOD/MiniAODHelper/data/jec/Summer16_23Sep2016BCDV4_DATA_L3Absolute_AK4PFchs.txt")
    process.BJetness.jecPayloadNamesAK4PFchsDATA4 = cms.FileInPath("MiniAOD/MiniAODHelper/data/jec/Summer16_23Sep2016BCDV4_DATA_L2L3Residual_AK4PFchs.txt")
    process.BJetness.jecPayloadNamesAK4PFchsDATAUnc = cms.FileInPath("MiniAOD/MiniAODHelper/data/jec/Summer16_23Sep2016BCDV4_DATA_Uncertainty_AK4PFchs.txt")
    process.BJetness.jerAK4PFchs   = cms.FileInPath("BoostedTTH/BoostedAnalyzer/data/jerfiles/Spring16_25nsV10_MC_PtResolution_AK4PFchs.txt")
    process.BJetness.jerAK4PFchsSF = cms.FileInPath("BoostedTTH/BoostedAnalyzer/data/jerfiles/Spring16_25nsV10_MC_SF_AK4PFchs.txt")
...
if options.calcBJetness and eleMVAid:

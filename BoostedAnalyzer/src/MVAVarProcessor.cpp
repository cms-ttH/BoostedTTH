...
void
MVAVarProcessor::Init(const InputCollections& input, VariableContainer& vars)
{
...
void
MVAVarProcessor::Process(const InputCollections& input, VariableContainer& vars)
{
  if (!initialized)
  ...
  float best_higgs_mass = bdtvar.getBestHiggsMass(primLepVecTL,
                                                  metvecTL,
                                                  jetvecsTL,
                                                  csvJets,
                                                  minChi,
  ...
  bdtvar.study_tops_bb_syst(input.correctedMET.corPt(pat::MET::Type1XY),
                            input.correctedMET.corP4(pat::MET::Type1XY).phi(),
                            dummy_metv,
                            primLepVecTL,
                            jets_vvdouble,
                            csvJets,

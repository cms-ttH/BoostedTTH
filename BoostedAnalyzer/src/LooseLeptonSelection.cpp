...
LooseLeptonSelection::LooseLeptonSelection(std::vector<std::string> electronTriggers_, std::vector<std::string> muonTriggers_, std::string channel_, int step_):electronTriggers(electronTriggers_),muonTriggers(muonTriggers_),channel(channel_),step(step_){
}

LooseLeptonSelection::LooseLeptonSelection(std::string electronTrigger, std::string muonTrigger, std::string channel_, int step_):LooseLeptonSelection(std::vector<std::string> (1,(electronTrigger)),std::vector<std::string> (1,muonTrigger),channel_,step_){
}

LooseLeptonSelection::LooseLeptonSelection(const edm::ParameterSet& iConfig, int step_):LooseLeptonSelection(iConfig.getParameter< std::vector<std::string> >("electronTriggers"),

...
void
GenTopFHSelection::InitCutflow(Cutflow& cutflow)
{
...
bool
GenTopFHSelection::IsSelected(const InputCollections& input, Cutflow& cutflow)
{
  if (!initialized)
    cerr << "GenTopFHSelection not initialized" << endl;

...
void
GenTopSLSelection::InitCutflow(Cutflow& cutflow)
{
...
bool
GenTopSLSelection::IsSelected(const InputCollections& input, Cutflow& cutflow)
{
  if (!initialized)
    cerr << "GenTopSLSelection not initialized" << endl;

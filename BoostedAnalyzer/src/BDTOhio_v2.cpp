...
BDTOhio_v2::BDTOhio_v2(TString weightPath)
  : btagMcut(0.8)
{
  // ==================================================
  ...
  readerMap["6j2t"]->AddVariable("second_jet_pt",
                                 &variableMap["second_jet_pt"]);
  readerMap["6j2t"]->AddVariable("fourth_jet_pt",
                                 &variableMap["fourth_jet_pt"]);
  readerMap["6j2t"]->AddVariable("h0", &variableMap["h0"]);
  readerMap["6j2t"]->AddVariable("h1", &variableMap["h1"]);
  readerMap["6j2t"]->AddVariable("all_sum_pt_with_met",
                                 &variableMap["all_sum_pt_with_met"]);
  readerMap["6j2t"]->AddVariable("HT", &variableMap["HT"]);
  readerMap["6j2t"]->AddVariable("h3", &variableMap["h3"]);
  readerMap["6j2t"]->AddVariable("third_highest_btag",
                                 &variableMap["third_highest_btag"]);
  readerMap["6j2t"]->AddVariable("fourth_highest_btag",
                                 &variableMap["fourth_highest_btag"]);
  readerMap["6j2t"]->AddVariable("fifth_highest_CSV",
                                 &variableMap["fifth_highest_CSV"]);
  readerMap["6j2t"]->AddVariable("maxeta_jet_jet",
                                 &variableMap["maxeta_jet_jet"]);
  readerMap["6j2t"]->AddVariable("Mlb", &variableMap["Mlb"]);
  readerMap["6j2t"]->AddVariable("pt_all_jets_over_E_all_jets",
                                 &variableMap["pt_all_jets_over_E_all_jets"]);

  readerMap["4j3t"]->AddVariable("first_jet_pt", &variableMap["first_jet_pt"]);
  readerMap["4j3t"]->AddVariable("second_jet_pt",
                                 &variableMap["second_jet_pt"]);
  readerMap["4j3t"]->AddVariable("third_jet_pt", &variableMap["third_jet_pt"]);
  readerMap["4j3t"]->AddVariable("all_sum_pt_with_met",
                                 &variableMap["all_sum_pt_with_met"]);
  readerMap["4j3t"]->AddVariable("HT", &variableMap["HT"]);
  readerMap["4j3t"]->AddVariable("avg_btag_disc_btags",
                                 &variableMap["avg_btag_disc_btags"]);
  readerMap["4j3t"]->AddVariable("dev_from_avg_disc_btags",
                                 &variableMap["dev_from_avg_disc_btags"]);
  readerMap["4j3t"]->AddVariable("second_highest_btag",
                                 &variableMap["second_highest_btag"]);
  readerMap["4j3t"]->AddVariable("third_highest_btag",
                                 &variableMap["third_highest_btag"]);
  readerMap["4j3t"]->AddVariable("invariant_mass_of_everything",
                                 &variableMap["invariant_mass_of_everything"]);

  readerMap["5j3t"]->AddVariable("second_jet_pt",
                                 &variableMap["second_jet_pt"]);
  readerMap["5j3t"]->AddVariable("third_jet_pt", &variableMap["third_jet_pt"]);
  readerMap["5j3t"]->AddVariable("fourth_jet_pt",
                                 &variableMap["fourth_jet_pt"]);
  readerMap["5j3t"]->AddVariable("all_sum_pt_with_met",
                                 &variableMap["all_sum_pt_with_met"]);
  readerMap["5j3t"]->AddVariable("HT", &variableMap["HT"]);
  readerMap["5j3t"]->AddVariable("avg_dr_tagged_jets",
                                 &variableMap["avg_dr_tagged_jets"]);
  readerMap["5j3t"]->AddVariable("avg_btag_disc_btags",
                                 &variableMap["avg_btag_disc_btags"]);
  readerMap["5j3t"]->AddVariable("dev_from_avg_disc_btags",
                                 &variableMap["dev_from_avg_disc_btags"]);
  readerMap["5j3t"]->AddVariable("h3", &variableMap["h3"]);
  readerMap["5j3t"]->AddVariable("second_highest_btag",
                                 &variableMap["second_highest_btag"]);
  readerMap["5j3t"]->AddVariable("third_highest_btag",
                                 &variableMap["third_highest_btag"]);
  readerMap["5j3t"]->AddVariable("maxeta_jet_jet",
                                 &variableMap["maxeta_jet_jet"]);
  readerMap["5j3t"]->AddVariable("maxeta_jet_tag",
                                 &variableMap["maxeta_jet_tag"]);
  readerMap["5j3t"]->AddVariable("maxeta_tag_tag",
                                 &variableMap["maxeta_tag_tag"]);

  readerMap["6j3t"]->AddVariable("third_jet_pt", &variableMap["third_jet_pt"]);
  readerMap["6j3t"]->AddVariable("fourth_jet_pt",
                                 &variableMap["fourth_jet_pt"]);
  readerMap["6j3t"]->AddVariable("all_sum_pt_with_met",
                                 &variableMap["all_sum_pt_with_met"]);
  readerMap["6j3t"]->AddVariable("HT", &variableMap["HT"]);
  readerMap["6j3t"]->AddVariable("avg_dr_tagged_jets",
                                 &variableMap["avg_dr_tagged_jets"]);
  readerMap["6j3t"]->AddVariable("avg_btag_disc_btags",
                                 &variableMap["avg_btag_disc_btags"]);
  readerMap["6j3t"]->AddVariable("dev_from_avg_disc_btags",
                                 &variableMap["dev_from_avg_disc_btags"]);
  readerMap["6j3t"]->AddVariable("h3", &variableMap["h3"]);
  readerMap["6j3t"]->AddVariable("second_highest_btag",
                                 &variableMap["second_highest_btag"]);
  readerMap["6j3t"]->AddVariable("third_highest_btag",
                                 &variableMap["third_highest_btag"]);
  readerMap["6j3t"]->AddVariable("fourth_highest_btag",
                                 &variableMap["fourth_highest_btag"]);
  readerMap["6j3t"]->AddVariable("maxeta_jet_tag",
                                 &variableMap["maxeta_jet_tag"]);
  readerMap["6j3t"]->AddVariable("maxeta_tag_tag",
                                 &variableMap["maxeta_tag_tag"]);
  readerMap["6j3t"]->AddVariable("min_dr_tagged_jets",
                                 &variableMap["min_dr_tagged_jets"]);
  readerMap["6j3t"]->AddVariable("pt_all_jets_over_E_all_jets",
                                 &variableMap["pt_all_jets_over_E_all_jets"]);

  readerMap["4j4t"]->AddVariable("h1", &variableMap["h1"]);
  readerMap["4j4t"]->AddVariable("avg_dr_tagged_jets",
                                 &variableMap["avg_dr_tagged_jets"]);
  readerMap["4j4t"]->AddVariable("sphericity", &variableMap["sphericity"]);
  readerMap["4j4t"]->AddVariable("avg_btag_disc_btags",
                                 &variableMap["avg_btag_disc_btags"]);
  readerMap["4j4t"]->AddVariable("dev_from_avg_disc_btags",
                                 &variableMap["dev_from_avg_disc_btags"]);
  readerMap["4j4t"]->AddVariable("h2", &variableMap["h2"]);
  readerMap["4j4t"]->AddVariable("closest_tagged_dijet_mass",
                                 &variableMap["closest_tagged_dijet_mass"]);
  readerMap["4j4t"]->AddVariable("h3", &variableMap["h3"]);
  readerMap["4j4t"]->AddVariable("second_highest_btag",
                                 &variableMap["second_highest_btag"]);
  readerMap["4j4t"]->AddVariable("third_highest_btag",
                                 &variableMap["third_highest_btag"]);
  readerMap["4j4t"]->AddVariable("fourth_highest_btag",
                                 &variableMap["fourth_highest_btag"]);
  readerMap["4j4t"]->AddVariable("maxeta_jet_jet",
                                 &variableMap["maxeta_jet_jet"]);
  readerMap["4j4t"]->AddVariable("min_dr_tagged_jets",
                                 &variableMap["min_dr_tagged_jets"]);
  readerMap["4j4t"]->AddVariable("pt_all_jets_over_E_all_jets",
                                 &variableMap["pt_all_jets_over_E_all_jets"]);
  ...
  readerMap["5j4t"]->AddVariable("fourth_jet_pt",
                                 &variableMap["fourth_jet_pt"]);
  readerMap["5j4t"]->AddVariable("h1", &variableMap["h1"]);
  readerMap["5j4t"]->AddVariable("avg_dr_tagged_jets",
                                 &variableMap["avg_dr_tagged_jets"]);
  readerMap["5j4t"]->AddVariable("sphericity", &variableMap["sphericity"]);
  readerMap["5j4t"]->AddVariable("avg_btag_disc_btags",
                                 &variableMap["avg_btag_disc_btags"]);
  readerMap["5j4t"]->AddVariable("dev_from_avg_disc_btags",
                                 &variableMap["dev_from_avg_disc_btags"]);
  readerMap["5j4t"]->AddVariable("h2", &variableMap["h2"]);
  readerMap["5j4t"]->AddVariable("h3", &variableMap["h3"]);
  readerMap["5j4t"]->AddVariable("third_highest_btag",
                                 &variableMap["third_highest_btag"]);
  readerMap["5j4t"]->AddVariable("fourth_highest_btag",
                                 &variableMap["fourth_highest_btag"]);
  readerMap["5j4t"]->AddVariable("maxeta_jet_jet",
                                 &variableMap["maxeta_jet_jet"]);
  readerMap["5j4t"]->AddVariable("maxeta_jet_tag",
                                 &variableMap["maxeta_jet_tag"]);
  readerMap["5j4t"]->AddVariable("maxeta_tag_tag",
                                 &variableMap["maxeta_tag_tag"]);
  readerMap["5j4t"]->AddVariable("pt_all_jets_over_E_all_jets",
                                 &variableMap["pt_all_jets_over_E_all_jets"]);

  readerMap["6j4t"]->AddVariable("avg_dr_tagged_jets",
                                 &variableMap["avg_dr_tagged_jets"]);
  readerMap["6j4t"]->AddVariable("avg_btag_disc_btags",
                                 &variableMap["avg_btag_disc_btags"]);
  readerMap["6j4t"]->AddVariable("h2", &variableMap["h2"]);
  readerMap["6j4t"]->AddVariable("h3", &variableMap["h3"]);
  readerMap["6j4t"]->AddVariable("second_highest_btag",
                                 &variableMap["second_highest_btag"]);
  readerMap["6j4t"]->AddVariable("third_highest_btag",
                                 &variableMap["third_highest_btag"]);
  readerMap["6j4t"]->AddVariable("fourth_highest_btag",
                                 &variableMap["fourth_highest_btag"]);
  readerMap["6j4t"]->AddVariable("maxeta_jet_jet",
                                 &variableMap["maxeta_jet_jet"]);
  readerMap["6j4t"]->AddVariable("maxeta_jet_tag",
                                 &variableMap["maxeta_jet_tag"]);
  readerMap["6j4t"]->AddVariable("maxeta_tag_tag",
                                 &variableMap["maxeta_tag_tag"]);
  readerMap["6j4t"]->AddVariable("pt_all_jets_over_E_all_jets",
                                 &variableMap["pt_all_jets_over_E_all_jets"]);
  readerMap["6j4t"]->AddVariable(
    "tagged_dijet_mass_closest_to_125",
    &variableMap["tagged_dijet_mass_closest_to_125"]);
  readerMap["6j4t"]->AddVariable("dEta_fn", &variableMap["dEta_fn"]);

  // ==================================================
  // book MVAs from weights
  readerMap["6j4t"]->BookMVA(
    "BDT", weightPath + "/643/TMVAClassification_BDT.weights.xml");
  readerMap["5j4t"]->BookMVA(
    "BDT", weightPath + "/543/TMVAClassification_BDT.weights.xml");
  readerMap["4j4t"]->BookMVA(
    "BDT", weightPath + "/443/TMVAClassification_BDT.weights.xml");
  readerMap["6j3t"]->BookMVA(
    "BDT", weightPath + "/633/TMVAClassification_BDT.weights.xml");
  readerMap["5j3t"]->BookMVA(
    "BDT", weightPath + "/533/TMVAClassification_BDT.weights.xml");
  readerMap["4j3t"]->BookMVA(
    "BDT", weightPath + "/433/TMVAClassification_BDT.weights.xml");
  readerMap["6j2t"]->BookMVA(
    "BDT", weightPath + "/623/TMVAClassification_BDT.weights.xml");
}
BDTOhio_v2::~BDTOhio_v2()
{
}
std::string
BDTOhio_v2::GetCategory(const std::vector<pat::Jet>& selectedJets) const
{
...
float
BDTOhio_v2::Evaluate(std::string categoryLabel,
                     ...
                     const pat::MET& correctedMET)
{
  ...
  if (selectedMuons.size() > 0)
    lepton_vec.SetPtEtaPhiE(selectedMuons[0].pt(),
                            selectedMuons[0].eta(),
                            selectedMuons[0].phi(),
                            selectedMuons[0].energy());
  if (selectedElectrons.size() > 0)
    lepton_vec.SetPtEtaPhiE(selectedElectrons[0].pt(),
                            selectedElectrons[0].eta(),
                            selectedElectrons[0].phi(),
                            selectedElectrons[0].energy());
  met_vec.SetPtEtaPhiE(
    correctedMET.pt(), 0, correctedMET.phi(), correctedMET.pt());
  for (auto jet = selectedJets.begin(); jet != selectedJets.end(); jet++) {
  ...
  for (auto jet = selectedJetsLoose.begin(); jet != selectedJetsLoose.end();
       jet++) {
    TLorentzVector jetvec;
    jetvec.SetPtEtaPhiE(jet->pt(), jet->eta(), jet->phi(), jet->energy());
  ...
  float bestHiggsMass = bdtvar.getBestHiggsMass(lepton_vec,
                                                met_vec,
                                                jet_vecs,
                                                jetCSV,
                                                minChi,
  ...
  double minChiStudy, chi2lepW, chi2leptop, chi2hadW, chi2hadtop, mass_lepW,
    mass_leptop, mass_hadW, mass_hadtop, dRbbStudy, testquant1, testquant2,
    testquant3, testquant4, testquant5, testquant6, testquant7;
  TLorentzVector b1, b2;
  bdtvar.study_tops_bb_syst(correctedMET.pt(),
                            correctedMET.phi(),
                            dummy_metv,
                            lepton_vec,
                            jets_vvdouble,
  ...
  for (auto jetvec = jet_vecs.begin(); jetvec != jet_vecs.end(); ++jetvec) {
    dr_between_lep_and_closest_jet =
      fmin(dr_between_lep_and_closest_jet, lepton_vec.DeltaR(*jetvec));
  ...
  for (auto tagged_jet = tagged_jet_vecs.begin();
       tagged_jet != tagged_jet_vecs.end();
       tagged_jet++) {
  ...
  for (auto tagged_jet1 = tagged_jet_vecs.begin();
       tagged_jet1 != tagged_jet_vecs.end();
       tagged_jet1++) {
    for (auto tagged_jet2 = tagged_jet1 + 1;
         tagged_jet2 != tagged_jet_vecs.end();
         tagged_jet2++) {
  ...
  float avgDrTagged = -1;
  if (npairs != 0)
    avgDrTagged = sumDrTagged / npairs;
  // M3
  float m3 = -1.;
  float maxpt_for_m3 = -1;
  for (auto itJetVec1 = jet_vecs.begin(); itJetVec1 != jet_vecs.end();
       ++itJetVec1) {
    for (auto itJetVec2 = itJetVec1 + 1; itJetVec2 != jet_vecs.end();
         ++itJetVec2) {
      for (auto itJetVec3 = itJetVec2 + 1; itJetVec3 != jet_vecs.end();
           ++itJetVec3) {
  ...
  variableMap["dr_between_lep_and_closest_jet"] =
    dr_between_lep_and_closest_jet;
...
BDTOhio_v2::GetAllOutputsOfLastEvaluation() const
{
...
float
BDTOhio_v2::Evaluate(const std::vector<pat::Muon>& selectedMuons,
                     const std::vector<pat::Electron>& selectedElectrons,
                     const std::vector<pat::Jet>& selectedJets,
                     const std::vector<pat::Jet>& selectedJetsLoose,
                     const pat::MET& correctedMET)
...
std::map<std::string, float>
BDTOhio_v2::GetVariablesOfLastEvaluation() const
{
  return variableMap;
}

...
void
BoostedAk4VarProcessor::Init(const InputCollections& input,
                             VariableContainer& vars)
{
  ...
  vars.InitVars(
    "BoostedAk4Cluster_Dr_Ak4Cluster_BoostedJet1", -9, "N_BoostedAk4Cluster");
  vars.InitVars(
    "BoostedAk4Cluster_Dr_Ak4Cluster_BoostedJet2", -9, "N_BoostedAk4Cluster");
  vars.InitVars(
    "BoostedAk4Cluster_Dr_Ak4Cluster_BoostedJet3", -9, "N_BoostedAk4Cluster");
...
void
BoostedAk4VarProcessor::Process(const InputCollections& input,
                                VariableContainer& vars)
{
  if (!initialized)
  ...
  for (int unsigned i = 0; i < input.selectedAk4Cluster.size(); ++i) {
    vars.FillVars(
      "BoostedAk4Cluster_E", i, input.selectedAk4Cluster[i].fatjet.E());
    vars.FillVars(
      "BoostedAk4Cluster_Pt", i, input.selectedAk4Cluster[i].fatjet.Pt());
    vars.FillVars(
      "BoostedAk4Cluster_M", i, input.selectedAk4Cluster[i].fatjet.M());
    vars.FillVars(
      "BoostedAk4Cluster_Eta", i, input.selectedAk4Cluster[i].fatjet.Eta());
    vars.FillVars(
      "BoostedAk4Cluster_Phi", i, input.selectedAk4Cluster[i].fatjet.Phi());
    vars.FillVars("BoostedAk4Cluster_N_Ak4Jets",
                  i,
    ...
    for (std::vector<pat::Jet>::const_iterator itAk4Jet =
      ...
      vars.FillVars("BoostedAk4Cluster_Ak4Jet" + iAk4JetNumber + "_E",
                    i,
                    itAk4Jet->energy());
      vars.FillVars(
        "BoostedAk4Cluster_Ak4Jet" + iAk4JetNumber + "_M", i, itAk4Jet->mass());
      vars.FillVars(
        "BoostedAk4Cluster_Ak4Jet" + iAk4JetNumber + "_Pt", i, itAk4Jet->pt());
      vars.FillVars("BoostedAk4Cluster_Ak4Jet" + iAk4JetNumber + "_Phi",
                    i,
                    itAk4Jet->phi());
      vars.FillVars("BoostedAk4Cluster_Ak4Jet" + iAk4JetNumber + "_Eta",
                    i,
                    itAk4Jet->eta());
    }
    ...
    if (input.selectedBoostedJets.size() > 0)
      vars.FillVars(
        "BoostedAk4Cluster_Dr_Ak4Cluster_BoostedJet1",
        i,
    ...
    if (input.selectedBoostedJets.size() > 1)
      vars.FillVars(
        "BoostedAk4Cluster_Dr_Ak4Cluster_BoostedJet2",
        i,
        BoostedUtils::DeltaR(input.selectedAk4Cluster[i].fatjet,
                             input.selectedBoostedJets[1].fatjet.p4()));
    if (input.selectedBoostedJets.size() > 2)
      vars.FillVars(
        "BoostedAk4Cluster_Dr_Ak4Cluster_BoostedJet3",
        i,
        BoostedUtils::DeltaR(input.selectedAk4Cluster[i].fatjet,

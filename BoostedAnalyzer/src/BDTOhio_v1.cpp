...
BDTOhio_v1::BDTOhio_v1(TString weightPath)
  : btagMcut(0.8)
  , btagger("pfCombinedInclusiveSecondaryVertexV2BJetTags")
{
  ...
  readerMap["4j3t"]->AddVariable("MET", &variableMap["MET"]);
  ...
  readerMap["4j3t"]->AddVariable("fourth_jet_pt",
  ...
  readerMap["5j3t"]->AddVariable("third_highest_btag",
                                 &variableMap["third_highest_btag"]);
  readerMap["5j3t"]->AddVariable("fourth_highest_btag",
                                 &variableMap["fourth_highest_btag"]);
  readerMap["5j3t"]->AddVariable("pt_all_jets_over_E_all_jets",
  ...
  readerMap["6j3t"]->AddVariable("h0", &variableMap["h0"]);
  readerMap["6j3t"]->AddVariable("all_sum_pt_with_met",
                                 &variableMap["all_sum_pt_with_met"]);
  readerMap["6j3t"]->AddVariable("sphericity", &variableMap["sphericity"]);
  ...
  readerMap["6j3t"]->AddVariable("fourth_highest_btag",
                                 &variableMap["fourth_highest_btag"]);
  readerMap["6j3t"]->AddVariable("maxeta_jet_jet",
                                 &variableMap["maxeta_jet_jet"]);
  ...
  readerMap["6j4t"]->AddVariable("avg_btag_disc_btags",
                                 &variableMap["avg_btag_disc_btags"]);
  readerMap["6j4t"]->AddVariable("closest_tagged_dijet_mass",
  ...
  readerMap["6j4t"]->AddVariable("pt_all_jets_over_E_all_jets",
                                 &variableMap["pt_all_jets_over_E_all_jets"]);
  readerMap["6j4t"]->AddVariable("best_higgs_mass",
                                 &variableMap["best_higgs_mass"]);
  readerMap["6j4t"]->AddVariable("dEta_fn", &variableMap["dEta_fn"]);

  readerMap["4j4t"]->AddVariable("first_jet_pt", &variableMap["first_jet_pt"]);
  readerMap["4j4t"]->AddVariable("second_jet_pt",
                                 &variableMap["second_jet_pt"]);
  readerMap["4j4t"]->AddVariable("fourth_jet_pt",
                                 &variableMap["fourth_jet_pt"]);
  readerMap["4j4t"]->AddVariable("all_sum_pt_with_met",
                                 &variableMap["all_sum_pt_with_met"]);
  ...
  readerMap["5j4t"]->AddVariable("all_sum_pt_with_met",
                                 &variableMap["all_sum_pt_with_met"]);
  ...
  readerMap["5j4t"]->AddVariable("second_highest_btag",
                                 &variableMap["second_highest_btag"]);
...
std::string
BDTOhio_v1::GetCategory(const std::vector<pat::Jet>& selectedJets) const
{
...
float
BDTOhio_v1::Evaluate(std::string categoryLabel,
...
BDTOhio_v1::GetAllOutputsOfLastEvaluation() const
{
...
float
BDTOhio_v1::Evaluate(const std::vector<pat::Muon>& selectedMuons,
                     const std::vector<pat::Electron>& selectedElectrons,
                     const std::vector<pat::Jet>& selectedJets,
                     const std::vector<pat::Jet>& selectedJetsLoose,
                     const pat::MET& correctedMET)
...
std::map<std::string, float>
BDTOhio_v1::GetVariablesOfLastEvaluation() const
{
  return variableMap;
}

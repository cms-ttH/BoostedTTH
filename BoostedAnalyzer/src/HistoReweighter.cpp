...
using namespace std;
HistoReweighter::HistoReweighter(TH1* nom_histo, TH1* denom_histo,
                                 bool normalize) {
...
HistoReweighter::HistoReweighter(const char* filename,
                                 ...
                                 const char* denom_histo_name, bool normalize) {
...
void HistoReweighter::CreateWeightHisto(TH1* nom_histo, TH1* denom_histo,
                                        bool normalize) {

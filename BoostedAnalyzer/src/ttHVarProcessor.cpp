...
void ttHVarProcessor::Process(const InputCollections& input,VariableContainer& vars){
  ...
  switch(recotype){
    ...
    case BoostedRecoType::BoostedTopHiggsAk4:
    {
      ttHEvent.BoostedTopHiggsAk4EventRec(toptagger, subjettype, higgstagger);
      break;
    }
    case BoostedRecoType::BoostedHiggsAk4:
    {
      ttHEvent.BoostedHiggsAk4EventRec(subjettype, higgstagger);
      break;
    }
    case BoostedRecoType::BoostedTopAk4:
    {

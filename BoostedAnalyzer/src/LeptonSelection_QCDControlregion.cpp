...
void
LeptonSelection_QCDControlregion::InitCutflow(Cutflow& cutflow)
{
  if (step < 0 || step == 1)
...
bool
LeptonSelection_QCDControlregion::IsSelected(const InputCollections& input,
                                             Cutflow& cutflow)
{
  if (!initialized)

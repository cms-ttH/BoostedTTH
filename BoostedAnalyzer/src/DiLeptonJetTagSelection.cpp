...
DiLeptonJetTagSelection::DiLeptonJetTagSelection(std::vector<int> minjets_,
                                                 std::vector<int> mintags_)
  : DiLeptonJetTagSelection(minjets_,
                            std::vector<int>(),
                            mintags_,
                            std::vector<int>())
{
...
DiLeptonJetTagSelection::DiLeptonJetTagSelection(int minjets_, int mintags_)
  : DiLeptonJetTagSelection(std::vector<int>(1, minjets_),
...
DiLeptonJetTagSelection::DiLeptonJetTagSelection(
  ...
  : DiLeptonJetTagSelection(iConfig.getParameter<std::vector<int>>("minJets"),
...
void
DiLeptonJetTagSelection::InitCutflow(Cutflow& cutflow)
{
...
bool
DiLeptonJetTagSelection::IsSelected(const InputCollections& input,
                                    Cutflow& cutflow)
{
  if (!initialized)
    cerr << "DiLeptonJetTagSelection not initialized" << endl;

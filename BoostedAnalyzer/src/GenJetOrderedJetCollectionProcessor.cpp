...
void
GenJetOrderedJetCollectionProcessor::Init(const InputCollections& input,
...
void
GenJetOrderedJetCollectionProcessor::Process(const InputCollections& input,
                                             VariableContainer& vars)
{
  if (!initialized)
...
bool
GenJetOrderedJetCollectionProcessor::getClosestJet(
...
double
GenJetOrderedJetCollectionProcessor::deltaR(const reco::GenJet& genJet,

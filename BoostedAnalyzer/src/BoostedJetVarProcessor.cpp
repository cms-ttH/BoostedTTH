...
void BoostedJetVarProcessor::Init(const InputCollections& input,VariableContainer& vars){
  ...
  vars.InitVars( "TopJet_FatJet_Mass","N_TopJets" );
  vars.InitVars( "TopJet_FatJet_Pt","N_TopJets" );
  vars.InitVars( "TopJet_FatJet_Eta","N_TopJets" );
  vars.InitVars( "TopJet_FatJet_Phi","N_TopJets" );

  vars.InitVars( "TopJet_TopMass","N_TopJets" );
  vars.InitVars( "TopJet_UnfilteredMass","N_TopJets" );
  vars.InitVars( "TopJet_PrunedMass","N_TopJets" );
  vars.InitVars( "TopJet_fRec","N_TopJets" );
  vars.InitVars( "TopJet_MassRatioPassed","N_TopJets" );

  vars.InitVars( "TopJet_Ropt","N_TopJets" );
  vars.InitVars( "TopJet_RoptCalc","N_TopJets" );
  vars.InitVars( "TopJet_PtForRoptCalc","N_TopJets" );

  vars.InitVars( "TopJet_Tau1Unfiltered","N_TopJets" );
  vars.InitVars( "TopJet_Tau2Unfiltered","N_TopJets" );
  vars.InitVars( "TopJet_Tau3Unfiltered","N_TopJets" );
  vars.InitVars( "TopJet_Tau1Filtered","N_TopJets" );
  vars.InitVars( "TopJet_Tau2Filtered","N_TopJets" );
  vars.InitVars( "TopJet_Tau3Filtered","N_TopJets" );

  vars.InitVars( "TopJet_QWeight","N_TopJets" );
  vars.InitVars( "TopJet_QEpsilon","N_TopJets" );
  vars.InitVars( "TopJet_QSigmaM","N_TopJets" );
...
void BoostedJetVarProcessor::Process(const InputCollections& input,VariableContainer& vars){
  ...
  for(size_t i=0; i< input.selectedHTTTopJets.size(); i++){
    ...
    vars.FillVars( "TopJet_B_CSV",i,fmax(nonW.bDiscriminator(btagger),-.1) );
    vars.FillVars( "TopJet_W1_CSV",i,fmax(W1.bDiscriminator(btagger),-.1) );
    vars.FillVars( "TopJet_W2_CSV",i,fmax(W2.bDiscriminator(btagger),-.1) );

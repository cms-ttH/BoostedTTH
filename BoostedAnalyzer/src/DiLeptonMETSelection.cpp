...
DiLeptonMETSelection::DiLeptonMETSelection(const edm::ParameterSet& iConfig) :
    DiLeptonMETSelection(iConfig.getParameter< double >("minMET"), iConfig.getParameter< double >("maxMET"))
{
}
...
bool DiLeptonMETSelection::IsSelected(const InputCollections& input, Cutflow& cutflow)
{
    ...
    if (nleadleptons >= 1 && ((nelectrons_p == 1 && nmuons_n == 1 && nelectrons_n == 0 && nmuons_p == 0) ||

...
void
LeptonSelection::InitCutflow(Cutflow& cutflow)
{
  if (step < 0 || step == 1)
...
bool
LeptonSelection::IsSelected(const InputCollections& input, Cutflow& cutflow)
{
  if (!initialized)
    cerr << "LeptonSelection not initialized" << endl;

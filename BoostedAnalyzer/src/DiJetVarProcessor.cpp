...
void DiJetVarProcessor::Init(const InputCollections& input,
...
void DiJetVarProcessor::Process(const InputCollections& input,
                                VariableContainer& vars) {
  if (!initialized)
...
void DiJetVarProcessor::fillSecondaryVertexInfo(VariableContainer& vars,
                                                const pat::Jet& jet,

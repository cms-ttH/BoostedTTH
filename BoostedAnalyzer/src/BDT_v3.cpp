...
BDT_v3::BDT_v3(TString weightPath)
  : btagMcut(0.8)
{
  // ==================================================
  ...
  readerMap["6j2t"]->AddVariable("BDTOhio_v2_input_avg_dr_tagged_jets",
                                 &variableMap["avg_dr_tagged_jets"]);
  readerMap["6j2t"]->AddVariable("BDTOhio_v2_input_sphericity",
                                 &variableMap["sphericity"]);
  readerMap["6j2t"]->AddVariable("BDTOhio_v2_input_third_highest_btag",
  ...
  readerMap["6j2t"]->AddVariable("BDTOhio_v2_input_fifth_highest_CSV",
                                 &variableMap["fifth_highest_CSV"]);
  readerMap["6j2t"]->AddVariable("BDTOhio_v2_input_fourth_highest_btag",
                                 &variableMap["fourth_highest_btag"]);

  // 43
  readerMap["4j3t"]->AddVariable("BDTOhio_v2_input_h1", &variableMap["h1"]);
  readerMap["4j3t"]->AddVariable("BDTOhio_v2_input_avg_dr_tagged_jets",
                                 &variableMap["avg_dr_tagged_jets"]);
  readerMap["4j3t"]->AddVariable("BDTOhio_v2_input_sphericity",
                                 &variableMap["sphericity"]);
  readerMap["4j3t"]->AddVariable("BDTOhio_v2_input_third_highest_btag",
                                 &variableMap["third_highest_btag"]);
  readerMap["4j3t"]->AddVariable("BDTOhio_v2_input_HT", &variableMap["HT"]);
  readerMap["4j3t"]->AddVariable("BDTOhio_v2_input_dev_from_avg_disc_btags",
                                 &variableMap["dev_from_avg_disc_btags"]);
  readerMap["4j3t"]->AddVariable("BDTOhio_v2_input_M3", &variableMap["M3"]);
  readerMap["4j3t"]->AddVariable("BDTOhio_v2_input_min_dr_tagged_jets",
                                 &variableMap["min_dr_tagged_jets"]);
  readerMap["4j3t"]->AddVariable("Evt_CSV_Average",
                                 &variableMap["Evt_CSV_Average"]);

  // 53
  readerMap["5j3t"]->AddVariable("BDTOhio_v2_input_h1", &variableMap["h1"]);
  readerMap["5j3t"]->AddVariable("BDTOhio_v2_input_avg_dr_tagged_jets",
                                 &variableMap["avg_dr_tagged_jets"]);
  readerMap["5j3t"]->AddVariable("BDTOhio_v2_input_sphericity",
                                 &variableMap["sphericity"]);
  readerMap["5j3t"]->AddVariable("BDTOhio_v2_input_third_highest_btag",
                                 &variableMap["third_highest_btag"]);
  ...
  readerMap["5j3t"]->AddVariable("BDTOhio_v2_input_dev_from_avg_disc_btags",
                                 &variableMap["dev_from_avg_disc_btags"]);
  readerMap["5j3t"]->AddVariable("BDTOhio_v2_input_fourth_highest_btag",
                                 &variableMap["fourth_highest_btag"]);

  // 63
  readerMap["6j3t"]->AddVariable("BDTOhio_v2_input_h1", &variableMap["h1"]);
  readerMap["6j3t"]->AddVariable("BDTOhio_v2_input_avg_dr_tagged_jets",
                                 &variableMap["avg_dr_tagged_jets"]);
  readerMap["6j3t"]->AddVariable("BDTOhio_v2_input_third_highest_btag",
                                 &variableMap["third_highest_btag"]);
  readerMap["6j3t"]->AddVariable("BDTOhio_v2_input_HT", &variableMap["HT"]);
  readerMap["6j3t"]->AddVariable("BDTOhio_v2_input_pt_all_jets_over_E_all_jets",
                                 &variableMap["pt_all_jets_over_E_all_jets"]);
  readerMap["6j3t"]->AddVariable("BDTOhio_v2_input_fifth_highest_CSV",
                                 &variableMap["fifth_highest_CSV"]);
  readerMap["6j3t"]->AddVariable("BDTOhio_v2_input_fourth_highest_btag",
                                 &variableMap["fourth_highest_btag"]);
  readerMap["6j3t"]->AddVariable("BDTOhio_v2_input_min_dr_tagged_jets",
                                 &variableMap["min_dr_tagged_jets"]);

  // 44
  readerMap["4j4t"]->AddVariable("BDTOhio_v2_input_h1", &variableMap["h1"]);
  readerMap["4j4t"]->AddVariable("BDTOhio_v2_input_avg_dr_tagged_jets",
                                 &variableMap["avg_dr_tagged_jets"]);
  readerMap["4j4t"]->AddVariable("BDTOhio_v2_input_sphericity",
                                 &variableMap["sphericity"]);
  readerMap["4j4t"]->AddVariable("BDTOhio_v2_input_avg_btag_disc_btags",
                                 &variableMap["avg_btag_disc_btags"]);
  readerMap["4j4t"]->AddVariable("BDTOhio_v2_input_h2", &variableMap["h2"]);
  readerMap["4j4t"]->AddVariable("BDTOhio_v2_input_closest_tagged_dijet_mass",
                                 &variableMap["closest_tagged_dijet_mass"]);
  readerMap["4j4t"]->AddVariable("BDTOhio_v2_input_second_highest_btag",
                                 &variableMap["second_highest_btag"]);
  readerMap["4j4t"]->AddVariable("BDTOhio_v2_input_fourth_highest_btag",
                                 &variableMap["fourth_highest_btag"]);
  readerMap["4j4t"]->AddVariable("BDTOhio_v2_input_maxeta_jet_jet",
                                 &variableMap["maxeta_jet_jet"]);
  readerMap["4j4t"]->AddVariable("BDTOhio_v2_input_pt_all_jets_over_E_all_jets",
                                 &variableMap["pt_all_jets_over_E_all_jets"]);

  // 54
  readerMap["5j4t"]->AddVariable("BDTOhio_v2_input_avg_dr_tagged_jets",
                                 &variableMap["avg_dr_tagged_jets"]);
  ...
  readerMap["5j4t"]->AddVariable("BDTOhio_v2_input_fifth_highest_CSV",
                                 &variableMap["fifth_highest_CSV"]);
  readerMap["5j4t"]->AddVariable("BDTOhio_v2_input_fourth_highest_btag",
                                 &variableMap["fourth_highest_btag"]);
  readerMap["5j4t"]->AddVariable("Evt_Deta_JetsAverage",
                                 &variableMap["Evt_Deta_JetsAverage"]);
  readerMap["5j4t"]->AddVariable("BDTOhio_v2_input_avg_btag_disc_btags",
                                 &variableMap["avg_btag_disc_btags"]);

  // 64
  readerMap["6j4t"]->AddVariable("BDTOhio_v2_input_h2", &variableMap["h2"]);
  readerMap["6j4t"]->AddVariable("BDTOhio_v2_input_avg_dr_tagged_jets",
                                 &variableMap["avg_dr_tagged_jets"]);
  readerMap["6j4t"]->AddVariable("BDTOhio_v2_input_third_highest_btag",
                                 &variableMap["third_highest_btag"]);
  readerMap["6j4t"]->AddVariable("BDTOhio_v2_input_M3", &variableMap["M3"]);
  readerMap["6j4t"]->AddVariable("BDTOhio_v2_input_fifth_highest_CSV",
                                 &variableMap["fifth_highest_CSV"]);
  readerMap["6j4t"]->AddVariable("BDTOhio_v2_input_fourth_highest_btag",
                                 &variableMap["fourth_highest_btag"]);
  readerMap["6j4t"]->AddVariable("BDTOhio_v2_input_best_higgs_mass",
                                 &variableMap["best_higgs_mass"]);
  readerMap["6j4t"]->AddVariable("BDTOhio_v2_input_dEta_fn",
                                 &variableMap["dEta_fn"]);
...
std::string
BDT_v3::GetCategory(const std::vector<pat::Jet>& selectedJets) const
{
...
float
BDT_v3::Evaluate(std::string categoryLabel,
...
BDT_v3::GetAllOutputsOfLastEvaluation() const
{
...
float
BDT_v3::Evaluate(const std::vector<pat::Muon>& selectedMuons,
                 const std::vector<pat::Electron>& selectedElectrons,
                 const std::vector<pat::Jet>& selectedJets,
                 const std::vector<pat::Jet>& selectedJetsLoose,
                 const pat::MET& correctedMET)
...
std::map<std::string, float>
BDT_v3::GetVariablesOfLastEvaluation() const
{
  return variableMap;
}

...
void
AdditionalJetProcessor::Init(const InputCollections& input,
                             VariableContainer& vars)
{
  ...
  vars.InitVars(
    "AdditionalLightGenJet_RecoJetPt", -9., "N_AdditionalLightGenJets");
  vars.InitVars(
    "AdditionalLightGenJet_RecoJetCSV", -9., "N_AdditionalLightGenJets");
...
const pat::Jet*
AdditionalJetProcessor::GetPatJet(const reco::GenJet& genjet,
...
void
AdditionalJetProcessor::Process(const InputCollections& input,
                                VariableContainer& vars)
{
  ...
  if (input.genTopEvt.TTxIsFilled()) {
    ...
    for (auto genjet = additional_light_genjets.begin();
         genjet != additional_light_genjets.end();
         genjet++) {
    ...
    for (uint i = 0; i < additional_b_genjets.size(); i++) {
      ...
      vars.FillVars(
        "AdditionalGenBJet_FromTopType", i, additional_b_genjets_fromtop[i]);
      vars.FillVars(
        "AdditionalGenBJet_NHadrons", i, additional_b_genjets_nhadrons[i]);
      vars.FillVars(
        "AdditionalGenBJet_HadronPt", i, additional_b_genjets_hadron[i].pt());
      vars.FillVars("AdditionalGenBJet_RecoJetPt",
                    i,
                    additional_b_genjets_recojets[i] != 0
                      ? additional_b_genjets_recojets[i]->pt()
                      : -1);
      vars.FillVars(
        "AdditionalGenBJet_RecoJetCSV",
        i,
        additional_b_genjets_recojets[i] != 0
          ? MiniAODHelper::GetJetCSV(*additional_b_genjets_recojets[i], btagger)
          : -2);
      vars.FillVars("AdditionalGenBJet_HadronId",
                    i,
    ...
    for (uint i = 0; i < additional_c_genjets.size(); i++) {
      ...
      vars.FillVars(
        "AdditionalGenCJet_FromTopType", i, additional_c_genjets_fromtop[i]);
      vars.FillVars(
        "AdditionalGenCJet_NHadrons", i, additional_c_genjets_nhadrons[i]);
      vars.FillVars(
        "AdditionalGenCJet_HadronPt", i, additional_c_genjets_hadron[i].pt());
      vars.FillVars("AdditionalGenCJet_RecoJetPt",
                    i,
                    additional_c_genjets_recojets[i] != 0
                      ? additional_c_genjets_recojets[i]->pt()
                      : -1);
      vars.FillVars(
        "AdditionalGenCJet_RecoJetCSV",
        i,
        additional_c_genjets_recojets[i] != 0
          ? MiniAODHelper::GetJetCSV(*additional_c_genjets_recojets[i], btagger)
          : -2);
      vars.FillVars("AdditionalGenCJet_HadronId",
                    i,
    ...
    for (uint i = 0; i < additional_light_genjets.size(); i++) {
      vars.FillVars(
        "AdditionalLightGenJet_Pt", i, additional_light_genjets[i].pt());
      vars.FillVars(
        "AdditionalLightGenJet_Eta", i, additional_light_genjets[i].eta());
      vars.FillVars(
        "AdditionalLightGenJet_Phi", i, additional_light_genjets[i].phi());
      vars.FillVars(
        "AdditionalLightGenJet_E", i, additional_light_genjets[i].energy());
      vars.FillVars("AdditionalLightGenJet_RecoJetPt",
                    i,
                    additional_light_genjets_recojets[i] != 0
                      ? additional_light_genjets_recojets[i]->pt()
                      : -1);
      vars.FillVars("AdditionalLightGenJet_RecoJetCSV",
                    i,
                    additional_light_genjets_recojets[i] != 0

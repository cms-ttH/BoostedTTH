...
void
VertexSelection::InitCutflow(Cutflow& cutflow)
{
...
bool
VertexSelection::IsSelected(const InputCollections& input, Cutflow& cutflow)
{
  if (!initialized)
    cerr << "VertexSelection not initialized" << endl;

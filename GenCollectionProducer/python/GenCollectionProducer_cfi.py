...
GenCollectionProducer = cms.EDProducer(
    ...
    collection_name=cms.vstring(
        "CustomGenElectrons", "CustomGenMuons", "CustomGenTaus", "CustomGenPhotons", "CustomGenJets", "CustomGenJetsAK8", "CustomGenJetsAK15"
    ),
    collection_type=cms.vstring("Electron", "Muon", "Tau", "Photon", "AK4Jet", "AK8Jet", "AK15Jet"),

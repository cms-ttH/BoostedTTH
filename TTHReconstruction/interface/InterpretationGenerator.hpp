...
public:
  InterpretationGenerator(IntType::IntType type=IntType::tth, int allowedMistags=1, int maxJets=10, float minMWHad=-99999,float maxMWHad=99999,float btagCut=0.8484);
